    ...
    internal static class DrunkFibonacci
    {
        ...
        public static IEnumerable<int> GetDrunkFibonacci()
        {
            ...
            */
            ...
            var fibonacci = GetFibonacci().GetEnumerator();
            for (int i = 0; ; ++i)
            {
                var curRand = rand.Current;
                rand.MoveNext();
                var curFibonacci = fibonacci.Current;
                fibonacci.MoveNext();
                if ((i + 1) % 6 == 0)
                {
                ...
                yield return nullSomeBits(curFibonacci, curRand);
        ...
        public static IEnumerable<int> GetXoredWithLaggedItself()
        {
            ...
            return Enumerable.Zip(GetDrunkFibonacci(), GetDrunkFibonacci().Skip(42), (x, y) => x ^ y);
        }
