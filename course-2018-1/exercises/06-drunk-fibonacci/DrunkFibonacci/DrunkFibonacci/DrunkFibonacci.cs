...
namespace DrunkFibonacci
{
    internal static class DrunkFibonacci
    {
        ...
        public static int[] CreateIntArray(int len)
        {
            ...
            if (len <= 0)
            {
                throw new ArgumentException("Incorrect length of array");
            }
            return new int[len];
        }
        ...
        public static IEnumerable<int> GetDrunkFibonacci()
        {
            ...
            */
            ...
            foreach (var randElem in GetDeterministicRandomSequence())
            {
                int curNum;
                ...
                {
                    curNum = unchecked(prevNum + prevPrevNum);
                }
                ...
                var oldPrevNum = prevNum;
                prevNum = unchecked(prevNum + prevPrevNum);
                prevPrevNum = oldPrevNum;
        ...
        public static IEnumerable<int[]> GetInChunks()
        {
            ...
            while (true)
            {
                yield return df.Take(16).ToArray();
                df = df.Skip(16);
            }
        }
