...
namespace DrunkFibonacci
{
    internal static class DrunkFibonacci
    {
        ...
        public static void FillIntArray(int[] arr, int seed, int step)
        {
            ...
            seed -= step;
            arr.ToList().Select(x => seed += step).ToArray().CopyTo(arr, 0);
        }
        ...
        public static IEnumerable<int> GetDrunkFibonacci()
        {
            ...
            */
            ...
            int DrunkReturn(int value, int random)
            {
                var hasBits = random & 42;
            ...
            while (true)
            {
                ...
                yield return DrunkReturn(first, sequence.ElementAt(current));
            }
        }
        ...
        public static IEnumerable<int[]> GetInChunks()
        {
            ...
            while (true)
            {
                chunk = sequence.Take(16).ToArray();
                yield return chunk;
            }
        }
        ...
        public static Dictionary<int, int> GetGroupSizes()
        {
            ...
            */
            return GetDrunkFibonacci().Take(10000).GroupBy(x => x > 0 ? x % 8 : 8 + x % 8)
