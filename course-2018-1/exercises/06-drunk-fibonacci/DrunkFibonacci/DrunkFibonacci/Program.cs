...
namespace DrunkFibonacci
{
    internal class Program
    {
        private static void Main()
        {
            ...
            Console.WriteLine("GetMaxOnRange: " + DrunkFibonacci.GetMaxOnRange(10, 40));
            Console.WriteLine("GetNextNegativeRange: " + string.Join(',', DrunkFibonacci.GetNextNegativeRange().Take(50)));
            Console.WriteLine("GetXoredWithLaggedItself: " + string.Join(',', DrunkFibonacci.GetXoredWithLaggedItself().Take(50)));
