...
namespace DrunkFibonacci
{
    internal class Program
    {
        private static void Main()
        {
            ...
            Console.WriteLine("GetMaxOnRange: " + DrunkFibonacci.GetMaxOnRange(1, 8));
            Console.WriteLine("GetMaxOnRange: " + DrunkFibonacci.GetMaxOnRange(1000, 400));
            Console.WriteLine();

            Console.WriteLine("GetNextNegativeRange: " + string.Join(',', DrunkFibonacci.GetNextNegativeRange(46).Take(2)));
