...
namespace CallMeMaybe.V1
{
    public class MaybeChef: IOneRecipeChef
    {
        ...
        private Maybe<BowlOf<FlourMixture>> MakeFlourMixture()
        {
            ...
            return _cookingTable.FindCupsOf<WholeWheatFlour>(1.5m).ToMaybe().Select(wholeWheatFlour =>
                _cookingTable.FindCupsOf<AllPurposeFlour>(1.5m).ToMaybe().Select(allPurposeFlour =>
