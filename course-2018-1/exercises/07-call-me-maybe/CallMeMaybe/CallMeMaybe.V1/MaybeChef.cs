        ...
        private Maybe<BowlOf<FlourMixture>> MakeFlourMixture()
        {
            ...
            */
            ...
            return _cookingTable.FindCupsOf<WholeWheatFlour>(3.5m).ToMaybe()
                .Select(flour => _cookingTable.FindCupsOf<AllPurposeFlour>(3.5m).ToMaybe()
                .Select(spice => _cookingTable.FindTeaspoonsOf<PumpkinPieSpice>(5m).ToMaybe()
                .Select(soda => _cookingTable.FindTeaspoonsOf<BakingSoda>(2m).ToMaybe()
