...
namespace CallMeMaybe.V1
{
    public struct Maybe<T>
    {
        ...
        */
        ...
        /// чтобы был один тип отсутствия значения (как null, так и у всяких типа int типов)
        /// 
        /// Сколько по факту будет экземпляров данного объекта?
        /// такое же кол-во, сколько различных типов T
        /// </summary>
        ...
        ///
        /// для работы только через фабрику (для null дб возвращено nothing, а в конструкторе этого не достичь)
        /// </summary>
