...
namespace CallMeMaybe.V1
{
    public struct Maybe<T>
    {
        /*
            ...
            Ответ: структура это ValueType => ей нельзя присвоить null. Это свойство нам нужно.
        */

        /// <summary>
        /// Зачем может быть нужно такое выделенное значение?
        /// Ответ: чтобы на пришедший в функцию null возвращать конкретное значение
        /// Сколько по факту будет экземпляров данного объекта?
        /// Ответ: Будет один объект т.к. указан спефикатор static.
        /// </summary>
        ...
        /// Ответ: требуем, чтобы все объекты создавались через вызов ToMaybe.
        /// </summary>
