...
namespace CallMeMaybe.V1
{
    public struct Maybe<T>
    {
        /*
            ...
            Struct is value type -> у нее всегда есть значение, она не может быть нулом
        */

        /// <summary>
        /// Зачем может быть нужно такое выделенное значение? одно понятное на всех
        /// Сколько по факту будет экземпляров данного объекта? один, он статический
        /// </summary>
        ...
        /// <summary>
        /// Как думаешь, почему я скрыл конструктор? потому что он принимает только ненулл?
        /// </summary>
