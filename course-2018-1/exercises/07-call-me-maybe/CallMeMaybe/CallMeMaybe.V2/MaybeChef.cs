    ...
    public class MaybeChef: IOneRecipeChef
    {
        ...
        private Maybe<BowlOf<FlourMixture>> MakeFlourMixture()
        {
            ...
            var result =
                ...
                from pumpkinPieSpice in _cookingTable.FindTeaspoonsOf<BakingSoda>(2m).ToMaybe()
        ...
        private Maybe<BowlOf<EggsMixture>> MakeEggsMixture()
        {
            /*
              ...
              *Ответ:* Если логика функций была перегружена, то придется сделать явный каст ToMaybe() .
            */
            var result =
