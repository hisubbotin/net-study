...
namespace CallMeMaybe.V2
{
    public class MaybeChef: IOneRecipeChef
    {
        ...
        private Maybe<BowlOf<FlourMixture>> MakeFlourMixture()
        {
            ...
            var result = 
                from wholeWheatFlour in _cookingTable.FindCupsOf<WholeWheatFlour>(1.5m).ToMaybe()
                from allPurposeFlour in _cookingTable.FindCupsOf<AllPurposeFlour>(1.5m).ToMaybe()
