...
namespace CallMeMaybe.BaseModel {
    public class NaiveChef : IOneRecipeChef {
        ...
        public IImmutableList<PumpkinMuffin> CookPumpkinMuffins() {
            ...
            var pumpkinMuffins =
                oven.Bake<PumpkinBatterCup, PumpkinMuffin>(backingDish.Value, TimeSpan.FromMinutes(30));
            return pumpkinMuffins?.Cups;
        }

        private BakingDish<PumpkinBatterCup>? PrepareBackingDish(BowlOf<FlourMixture> flourMixture,
