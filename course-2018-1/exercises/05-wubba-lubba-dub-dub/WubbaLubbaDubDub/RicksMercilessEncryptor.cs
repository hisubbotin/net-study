...
namespace WubbaLubbaDubDub
{
    public static class RicksMercilessEncryptor
    {
        ...
        public static string InverseCase(this string s)
        {
            ...
            */
            return string.Join("", s.Select(c => char.IsLower(c) ? char.ToUpper(c) : char.ToLower(c)));
        }
        ...
        {
            return string.Join("", s.Select(c => (char)(Convert.ToInt32(c) + 1)));
        }
