...
namespace Numbers
{
    public static class FloatNumbers
    {
        ...
        internal static bool IsNaN(double d)
        {
            ...
            return d.Equals(FloatNumbers.GetNaN());
        }
        ...
        internal static int Compare(/* дополни сигнатуру метода как считаешь правильным */double first, double second, double eps = 0.00001)
        {
            /*
