...
namespace Numbers
{
    public static class FloatNumbers
    {
        ...
        internal static int Compare(double first, double second/* дополни сигнатуру метода как считаешь правильным */)
        {
            /*
            ...
            */
            if (Math.Abs(second - first) < Double.Epsilon)
            {
                return 0;
            }
