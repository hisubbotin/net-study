...
namespace AdventureTime
{
    ...
    internal static class Time
    {
        ...
        public static int GetTotalMinutesInThreeMonths()
        {
            ...
            //throw new NotImplementedException();
            DateTime l = new DateTime(2018, 1, 1);
            DateTime r = new DateTime(2018, 4, 1);
            TimeSpan ts = r - l;
        ...
        public static int GetAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                ...
                Держи, заготовочку для копипасты:
                    - 2010, 3, 28, 2, 15, 0
            */
            DateTimeOffset d = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(3, 0, 0));
            DateTimeOffset ar = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(0, 0, 0));
            //throw new NotImplementedException();
            TimeSpan ts = ar - d;
            return (int)ts.TotalMinutes;
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            ...
            */
            //throw new NotImplementedException();
            DateTimeOffset d = new DateTimeOffset(2010, 3, 28, 3, 15, 0, new TimeSpan(3, 0, 0));
            DateTimeOffset ar = new DateTimeOffset(2010, 3, 28, 1, 15, 0, new TimeSpan(0, 0, 0));
            TimeSpan ts = ar - d;
            return (int)ts.TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver1_FeelsSmarter()
        {
            ...
            */
            //throw new NotImplementedException();
            DateTimeOffset d = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(4, 0, 0));
            DateTimeOffset ar = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(1, 0, 0));
            TimeSpan ts = ar - d;
            return (int)ts.TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            DateTimeOffset d = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), moscowZoneId);
            DateTimeOffset ar = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), londonZoneId);
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            const string londonZoneId = "GMT Standard Time";
            //throw new NotImplementedException();
            DateTimeOffset d = GetZonedTime(new DateTime(2010, 3, 28, 3, 15, 0), moscowZoneId);
            DateTimeOffset ar = GetZonedTime(new DateTime(2010, 3, 28, 1, 15, 0), londonZoneId);
