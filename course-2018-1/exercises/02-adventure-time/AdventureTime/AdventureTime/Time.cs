...
namespace AdventureTime
{
    ...
    public static class Time
    {
        ...
        public static DateTime AddTenSecondsV2(DateTime dt)
        {
            ...
            */
            var tenSeconds = new System.TimeSpan(0, 0, 10);
            return dt + tenSeconds;
        }
        ...
        public static int GetHoursBetween(DateTime dt1, DateTime dt2)
        {
            ...
            */
            var delta = dt1 - dt2;
            return Math.Abs(delta.Hours + delta.Days * 24);
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                ...
                Держи, заготовочку для копипасты:
                    - 2010, 3, 28, 2, 15, 0
            */
            var dto1 = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(3, 0, 0));
            var dto2 = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(0, 0, 0));
            return (int) (dto2 - dto1).TotalMinutes;
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                Здесь то же самое. Сорри, немного бездумного кодинга. Вот заготовочка для копипасты времени:
                    ...
                    - 2010, 3, 28, 1, 15, 0
            */
            var dto1 = new DateTimeOffset(2010, 3, 28, 3, 15, 0, new TimeSpan(3, 0, 0));
            var dto2 = new DateTimeOffset(2010, 3, 28, 1, 15, 0, new TimeSpan(0, 0, 0));
            return (int) (dto2 - dto1).TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver1_FeelsSmarter()
        {
            ...
            */
            var dto1 = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(4, 0, 0));
            var dto2 = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(1, 0, 0));
            return (int) (dto2 - dto1).TotalMinutes;
        }
...
//            var dto1 = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), moscowZoneId);
//            var dto2 = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), londonZoneId);
//            return (int) (dto2 - dto1).TotalMinutes;
