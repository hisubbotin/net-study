...
namespace AdventureTime
{
    ...
    internal static class Time
    {
        ...
        public static DateTime ParseFromRoundTripFormat(string dtStr)
        {
            ...
            */
            return DateTime.Parse(dtStr, CultureInfo.InvariantCulture, DateTimeStyles.RoundtripKind);
        }
        ...
        public static int GetTotalMinutesInThreeMonths()
        {
            ...
            TimeSpan difference = dt.AddMonths(3) - dt;
        ...
        public static int GetAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            ...
            */
            ...
            return (int)(londonDt - moscowDt).TotalMinutes;
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                Здесь то же самое. Сорри, немного бездумного кодинга. Вот заготовочка для копипасты времени:
                    ...
                    - 2010, 3, 28, 1, 15, 0
            */
            DateTimeOffset londonDt = new DateTimeOffset(2010, 3, 28, 3, 15, 0, TimeSpan.FromHours(0));
            DateTimeOffset moscowDt = new DateTimeOffset(2010, 3, 28, 1, 15, 0, TimeSpan.FromHours(3));
            return (int)(londonDt - moscowDt).TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver1_FeelsSmarter()
        {
            ...
            */
            DateTimeOffset londonDt = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(1));
            DateTimeOffset moscowDt = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(4));
            return (int)(londonDt - moscowDt).TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            var moscowDt = new LocalDateTime(2010, 3, 28, 2, 15, 0);
            var londonDt = new LocalDateTime(2010, 3, 28, 2, 15, 0);

            var moscowZoned = GetZonedTime(moscowDt, moscowZoneId);
            var londonZoned = GetZonedTime(londonDt, londonZoneId);

            return (int)(londonZoned - moscowZoned).TotalMinutes;
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            var moscowDt = new LocalDateTime(2010, 3, 28, 3, 15, 0);
            var londonDt = new LocalDateTime(2010, 3, 28, 1, 15, 0);
