...
namespace AdventureTime
{
    ...
    public static class Time
    {
        ...
        public static int GetTotalMinutesInThreeMonths()
        {
            ...
            // # окееей, зачем мне понадобится эта функция, куда не передаются параметры?
            // # обычно, такое пишется в терминале в питоне, чтобы прикинуть значение
            return (int) TimeSpan.FromDays((int) ((31 * 7 + 28 + 30 * 5) / 4)).TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                ...
                Держи, заготовочку для копипасты:
                    - 2010, 3, 28, 2, 15, 0
            */
            DateTimeOffset departure = new DateTimeOffset(new DateTime(2010, 3, 28, 2, 15, 0), TimeSpan.FromHours(3));
            DateTimeOffset landing = new DateTimeOffset(new DateTime(2010, 3, 28, 2, 15, 0), TimeSpan.FromHours(0));
            TimeSpan lol_im_flying = landing - departure;
            return (int) lol_im_flying.TotalMinutes;
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                Здесь то же самое. Сорри, немного бездумного кодинга. Вот заготовочка для копипасты времени:
                    ...
                    - 2010, 3, 28, 1, 15, 0
            */
            DateTimeOffset no_really = new DateTimeOffset(new DateTime(2010, 3, 28, 2, 15, 0), TimeSpan.FromHours(3));
            DateTimeOffset i_wanna_sleep = new DateTimeOffset(new DateTime(2010, 3, 28, 2, 15, 0), TimeSpan.FromHours(0));
            TimeSpan thats_fairy_tail_everybody_loves_sleeping = i_wanna_sleep - no_really;
            return (int)thats_fairy_tail_everybody_loves_sleeping.TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver1_FeelsSmarter()
        {
            /*
                ...
                # Yep, I've got that summer time sadnes
            ...
            */
            DateTimeOffset no_really = new DateTimeOffset(new DateTime(2010, 3, 28, 2, 15, 0), TimeSpan.FromHours(4));
            DateTimeOffset i_wanna_sleep = new DateTimeOffset(new DateTime(2010, 3, 28, 2, 15, 0), TimeSpan.FromHours(1));
            TimeSpan thats_fairy_tail_everybody_loves_sleeping = i_wanna_sleep - no_really;
            return (int)thats_fairy_tail_everybody_loves_sleeping.TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            DateTimeOffset when_i_will_be_sad = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), moscowZoneId);
            DateTimeOffset i_ll_do_csharp_hw = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), londonZoneId);
            TimeSpan happy_time = i_ll_do_csharp_hw - when_i_will_be_sad;
            return (int) happy_time.TotalMinutes;
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            DateTimeOffset moscow_time = GetZonedTime(new DateTime(2010, 3, 28, 3, 15, 0), moscowZoneId);
            DateTimeOffset london_time= GetZonedTime(new DateTime(2010, 3, 28, 1, 15, 0), londonZoneId);
            return (int) (london_time - moscow_time).TotalMinutes;
        }
