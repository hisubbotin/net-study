...
namespace AdventureTime
{
    ...
    public static class Time
    {
        ...
        public static int GetTotalMinutesInThreeMonths()
        {
            ...
            return (int)TimeSpan.FromDays(30 + 31 + 30).TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver1_FeelsSmarter()
        {
            ...
            */
            DateTimeOffset start = new DateTimeOffset(new DateTime(2010, 3, 28, 2, 15, 0), TimeSpan.FromHours(4));
            DateTimeOffset end = new DateTimeOffset(new DateTime(2010, 3, 28, 2, 15, 0), TimeSpan.FromHours(1));
            TimeSpan duration = end - start;
            return (int)duration.TotalMinutes;
        }
