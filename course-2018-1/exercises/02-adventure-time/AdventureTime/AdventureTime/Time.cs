...
namespace AdventureTime
{
    ...
    public static class Time
    {
        ...
        public static DateTime AddTenSecondsV2(DateTime dt)
        {
            ...
            */
            var tenSeconds = new TimeSpan(0, 0, 0, 10);
        ...
        public static int GetTotalMinutesInThreeMonths()
        {
            ...
            var threeMonths = new DateTime(2018, 4, 1, 0, 0, 0, 0) - new DateTime(2018, 1, 1, 0, 0, 0, 0);
        ...
        public static int GetAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                ...
                Держи, заготовочку для копипасты:
                    - 2010, 3, 28, 2, 15, 0
            */
           var Moscow = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(3, 0, 0));
           var London = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(0, 0, 0));
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                Здесь то же самое. Сорри, немного бездумного кодинга. Вот заготовочка для копипасты времени:
                    ...
                    - 2010, 3, 28, 1, 15, 0
            */
            var Moscow = new DateTimeOffset(2010, 3, 28, 3, 15, 0, new TimeSpan(3, 0, 0));
            var London = new DateTimeOffset(2010, 3, 28, 1, 15, 0, new TimeSpan(0, 0, 0));
            return (int)(London - Moscow).TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver1_FeelsSmarter()
        {
            ...
            */
            var Moscow = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(4, 0, 0));
            var London = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(1, 0, 0));
            return (int)(London - Moscow).TotalMinutes;
        }
