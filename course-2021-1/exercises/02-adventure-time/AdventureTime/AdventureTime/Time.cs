...
namespace AdventureTime
{
    ...
    internal static class Time
    {
        ...
        public static int GetAdventureTimeDurationInMinutes_ver1_FeelsSmarter()
        {
            ...
            */
            DateTimeOffset moscowTime = new DateTimeOffset(2010, 3, 28, 3, 15, 0, new TimeSpan(4, 0, 0));
            DateTimeOffset londonTime = new DateTimeOffset(2010, 3, 28, 1, 15, 0, new TimeSpan(1, 0, 0));
            return (int)(londonTime - moscowTime).TotalMinutes;
        }
        ...
        {
            DateTime person1birthdayUtc = ToUtc(person1Birthday);
            DateTime person2birthdayUtc = ToUtc(person2Birthday);
