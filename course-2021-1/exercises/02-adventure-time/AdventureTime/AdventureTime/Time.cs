    ...
    internal static class Time
    {
        ...
        public static int GetHoursBetween(DateTime dt1, DateTime dt2)
        {
            ...
            */
            ...
            return (int) (ToUtc(dt2) - ToUtc(dt1)).TotalHours;
        }
        ...
        public static int GetTotalMinutesInThreeMonths()
        {
            ...
            return (int) TimeSpan.FromDays(30 * 3).TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                ...
                Держи, заготовочку для копипасты:
                    - 2010, 3, 28, 2, 15, 0
            */
            var moscow_time = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(3, 0, 0));
            var london_time = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(0, 0, 0));
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                Здесь то же самое. Сорри, немного бездумного кодинга. Вот заготовочка для копипасты времени:
                    ...
                    - 2010, 3, 28, 1, 15, 0
            */
            var moscow_time = new DateTimeOffset(2010, 3, 28, 3, 15, 0, new TimeSpan(3, 0, 0));
            var london_time = new DateTimeOffset(2010, 3, 28, 1, 15, 0, new TimeSpan(0, 0, 0));
            return (int) (london_time - moscow_time).TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver1_FeelsSmarter()
        {
            ...
            */
            var moscow_time = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(4, 0, 0));
            var london_time = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(1, 0, 0));
            return (int) (london_time - moscow_time).TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            var moscow_time = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), moscowZoneId);
            var london_time = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), londonZoneId);
            return (int) (london_time - moscow_time).TotalMinutes;
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            var moscow_time = GetZonedTime(new DateTime(2010, 3, 28, 3, 15, 0), moscowZoneId);
            var london_time = GetZonedTime(new DateTime(2010, 3, 28, 1, 15, 0), londonZoneId);
            return (int) (london_time - moscow_time).TotalMinutes;
        }
        ...
        {
            var person1Birthday_utc = ToUtc(person1Birthday);
            var person2Birthday_utc = ToUtc(person2Birthday);
            return person1Birthday_utc.Month == person2Birthday_utc.Month && person1Birthday_utc.Day == person2Birthday_utc.Day;
        }
    }
}
