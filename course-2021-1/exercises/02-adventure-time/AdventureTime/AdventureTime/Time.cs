...
namespace AdventureTime
{
    ...
    internal static class Time
    {
        ...
        public static int GetAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                ...
                Держи, заготовочку для копипасты:
                    - 2010, 3, 28, 2, 15, 0
            */
            DateTimeOffset toTime = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(0));
            DateTimeOffset fromTime = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(3));
            return (int) (toTime - fromTime).TotalMinutes;
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                Здесь то же самое. Сорри, немного бездумного кодинга. Вот заготовочка для копипасты времени:
                    ...
                    - 2010, 3, 28, 1, 15, 0
            */
            DateTimeOffset toTime = new DateTimeOffset(2010, 3, 28, 3, 15, 0, TimeSpan.FromHours(0));
            DateTimeOffset fromTime = new DateTimeOffset(2010, 3, 28, 1, 15, 0, TimeSpan.FromHours(3));
            return (int) (toTime - fromTime).TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver1_FeelsSmarter()
        {
            ...
            */
            DateTimeOffset toTime = new DateTimeOffset(2010, 3, 28, 3, 15, 0, TimeSpan.FromHours(1));
            DateTimeOffset fromTime = new DateTimeOffset(2010, 3, 28, 1, 15, 0, TimeSpan.FromHours(4));
            return (int) (toTime - fromTime).TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            var toTime = GetZonedTime(new DateTime(2010, 3, 28, 3, 15, 0), londonZoneId);
            var fromTime = GetZonedTime(new DateTime(2010, 3, 28, 1, 15, 0), moscowZoneId);
            return (int) (toTime - fromTime).TotalMinutes;
        }
