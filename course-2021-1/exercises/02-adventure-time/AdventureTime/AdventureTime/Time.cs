...
namespace AdventureTime
{
    ...
    internal static class Time
    {
        ...
        public static int GetAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                ...
                Держи, заготовочку для копипасты:
                    - 2010, 3, 28, 2, 15, 0
            */
            var begin = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(3));
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                Здесь то же самое. Сорри, немного бездумного кодинга. Вот заготовочка для копипасты времени:
                    ...
                    - 2010, 3, 28, 1, 15, 0
            */
            var begin = new DateTimeOffset(2010, 3, 28, 3, 15, 0, TimeSpan.FromHours(3));
        ...
        public static int GetAdventureTimeDurationInMinutes_ver1_FeelsSmarter()
        {
            ...
            */
            var begin = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(4));
        ...
        public static int GetAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            var begin = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), moscowZoneId);
            var end = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), londonZoneId);;
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            var begin = GetZonedTime(new DateTime(2010, 3, 28, 3, 15, 0), moscowZoneId);
            var end = GetZonedTime(new DateTime(2010, 3, 28, 1, 15, 0), londonZoneId);;
        ...
        internal static bool AreEqualBirthdays(DateTime person1Birthday, DateTime person2Birthday)
        {
            ...
            {
                throw new ArgumentException("person1Birthday.Kind and person2Birthday.Kind must be DateTimeKind.Utc");
            }
