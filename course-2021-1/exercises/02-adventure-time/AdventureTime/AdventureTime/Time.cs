...
namespace AdventureTime
{
    ...
    internal static class Time
    {
        ...
        public static DateTime ParseFromRoundTripFormat(string dtStr)
        {
            ...
            */
            return DateTime.Parse(dtStr, new DateTimeFormatInfo());
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            ...
            */
            ...
            DateTimeOffset londonDt = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.Zero);
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            ...
            */
            ...
            DateTimeOffset londonDt = new DateTimeOffset(2010, 3, 28, 1, 15, 0, TimeSpan.Zero);
            return (int)((londonDt - moscowDt).TotalMinutes);
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            DateTimeOffset moscowDt = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), moscowZoneId);
            DateTimeOffset londonDt = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), londonZoneId);
            return (int)((londonDt - moscowDt).TotalMinutes);
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            DateTimeOffset moscowDt = GetZonedTime(new DateTime(2010, 3, 28, 3, 15, 0), moscowZoneId);
            DateTimeOffset londonDt = GetZonedTime(new DateTime(2010, 3, 28, 1, 15, 0), londonZoneId);
            return (int)((londonDt - moscowDt).TotalMinutes);
        }
