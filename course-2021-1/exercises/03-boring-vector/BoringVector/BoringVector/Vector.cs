    ...
    */
    ...
    internal class Vector
    {
        ...
        */
        ...
        /// </summary>
        /// <param name="v">Вектор, который будет прибавлен к текущему.</param>
        ...
        /// </summary>
        /// <param name="v">Коэффициент.</param>
        ...
        /// </summary>
        /// <param name="v">Вектор, с которым берётся скалярное произведение.</param>
        ...
        /// </summary>
        /// <param name="v">Вектор, с которым берётся векторное произведение.</param>
    ...
    */
    ...
    /*
        ...
        Плюсы Xml documentation comments:
            ...
            ссылки, например, <see cref=Vector.DotProduct"/>, и это будет
