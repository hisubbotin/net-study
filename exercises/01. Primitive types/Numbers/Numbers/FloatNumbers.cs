...
namespace Numbers
{
    public static class FloatNumbers
    {
        ...
        {
            // Подсказка: по аналогии с константами типа int, у типа double тоже есть свой набор констант.D:\DotNetCourse\net-study\exercises\01-primitive-types\Numbers\Numbers\FloatNumbers.cs
        ...
        internal static int Compare(double first, double second, double epsilon)
        {
            /*
