...
, то увидим, что каждая последовательность сгенерирована ___с самого начала___. Решарпер обычно в таких случаях показывает ворнинг "possible multiple enumeration of ienumerable" - мол, ты перечисление несколько раз итерируешь с самого начала.
...
Довольно частой ошибкой было оперировать одним и тем же буффером для чанка:
...
Частой ошибкой было использовать `XOR`: `x = x ^ 42;`
