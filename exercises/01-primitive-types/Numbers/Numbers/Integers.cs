...
namespace Numbers
{
    ...
    public static class Integers
    {
        ...
        internal static int TenTimes(int x)
        {
            ...
            */
			/*
			 * Название TenTimes тут не очень удачное - times тут слово арифметическое
			 * и юзер обычно подразумевает, что метод с таким методом будет выполнятся
			 * без всяких ToString и Parse:)
			 * Лучше было бы что-нибудь в стиле int AppendZero(int x)
			 */
