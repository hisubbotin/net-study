    ...
    public static class Integers
    {
        ...
        internal static int CubeWithOverflowCheck(int x)
        {
            ...
            */
            ...
            /* 
             * По умолчанию не используется ни checked, ни unchecked, а контекст, который много от чего зависит
             * (например, от константности или параметров компилятора).
             */
        }
        ...
        internal static int Parse(string s)
        {
            ...
            */
            return int.Parse(s);  // выбрасывает исключение, если s нельзя распарсить
        }
