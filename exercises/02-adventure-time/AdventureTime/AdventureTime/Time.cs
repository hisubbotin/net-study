...
namespace AdventureTime
{
    ...
    internal static class Time
    {
        ...
        public static int GetHoursBetween(DateTime dt1, DateTime dt2)
        {
            ...
            */
            return (int) Math.Floor((dt2.ToUniversalTime() - dt1.ToUniversalTime()).TotalHours + 0.0001);
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                ...
                Держи, заготовочку для копипасты:
                    - 2010, 3, 28, 2, 15, 0
            */
            var dt1 = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(3));
            var dt2 = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.Zero);
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                Здесь то же самое. Сорри, немного бездумного кодинга. Вот заготовочка для копипасты времени:
                    ...
                    - 2010, 3, 28, 1, 15, 0
            */
            var dt1 = new DateTimeOffset(2010, 3, 28, 3, 15, 0, TimeSpan.FromHours(3));
            var dt2 = new DateTimeOffset(2010, 3, 28, 1, 15, 0, TimeSpan.Zero);
            return (int) (dt2 - dt1).TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver1_FeelsSmarter()
        {
            ...
            */
            var dt1 = new DateTimeOffset(2010, 3, 28, 3, 15, 0, TimeSpan.FromHours(4));
            var dt2 = new DateTimeOffset(2010, 3, 28, 1, 15, 0, TimeSpan.FromHours(1));
            return (int) (dt2 - dt1).TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            var dt1 = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), moscowZoneId);
            var dt2 = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), londonZoneId);
        ...
        {
            if (
                person1Birthday.Kind == DateTimeKind.Unspecified &&
