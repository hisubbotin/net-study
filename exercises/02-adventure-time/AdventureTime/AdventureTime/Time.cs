...
namespace AdventureTime
{
    ...
    internal static class Time
    {
        ...
        public static int GetTotalMinutesInThreeMonths()
        {
            ...
            // Очень интересно, с учетом того, что три месяца могут быть разными... Ну пусть будут рандомные
        ...
        public static int GetAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            /*
             * А вот нет, они, кажется, windows-specific и из под linux из коробки не работали. Да, скорее всего надо
             * соответствующий пакет поставить, но лень думать.
             */
