...
// так как сдать надо все 6 задач, то пролистываю чатик до места ожесточенных споров...
// и начинаю писать
...
namespace AdventureTime
{
    ...
    internal static class Time
    {
        ...
        {
            // поняла я, поняла - удаляю комментарии :)
            return DateTime.Now;
        }
        ...
        public static int GetHoursBetween(DateTime dt1, DateTime dt2)
        {
            ...
            */
            TimeSpan result = dt1.ToUniversalTime() - dt2.ToUniversalTime();
            return (int)result.TotalHours;
        }
        ...
        public static int GetTotalMinutesInThreeMonths()
        {
            ...
            return (int)(timeNow.AddMonths(3) - timeNow).TotalHours;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            var dt1 = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), moscowZoneId.Id);
            var dt2 = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), londonZoneId.Id);
            return (int)(dt2 - dt1).TotalMinutes;
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            var dt1 = GetZonedTime(new DateTime(2010, 3, 28, 3, 15, 0), moscowZoneId.Id);
            var dt2 = GetZonedTime(new DateTime(2010, 3, 28, 1, 15, 0), londonZoneId.Id);
            return (int)(dt2 - dt1).TotalMinutes;
        }
