    ...
    internal static class Time
    {
        ...
        public static int GetAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            var moscow = new DateTime(2010, 3, 28, 2, 15, 0);
            var london = new DateTime(2010, 3, 28, 2, 15, 0);
            return (int)(GetZonedTime(london, londonZoneId.Id) - GetZonedTime(moscow, moscowZoneId.Id)).TotalMinutes;
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            var moscowZoneId = TimeZoneInfo.FindSystemTimeZoneById("Russian Standard Time");
            var londonZoneId = TimeZoneInfo.FindSystemTimeZoneById("GMT Standard Time");
            var moscow = new DateTime(2010, 3, 28, 3, 15, 0);
