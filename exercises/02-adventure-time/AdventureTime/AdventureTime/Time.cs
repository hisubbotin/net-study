...
namespace AdventureTime
{
    ...
    internal static class Time
    {
        ...
        public static int GetHoursBetween(DateTime dt1, DateTime dt2)
        {
            ...
            */
            //.ToUniversalTime() учитывает kind
            //+1e-4 против ошибки округления
            return (int)Math.Floor((dt2.ToUniversalTime() - dt1.ToUniversalTime()).TotalHours + 1e-4);
        }
        ...
        public static int GetTotalMinutesInThreeMonths()
        {
            ...
            return (int)Math.Floor((dt2 - dt1).TotalMinutes + 1e-4);
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            ...
            */
            ...
            return (int)Math.Floor((timeLondon - timeMoscow).TotalMinutes + 1e-4);
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                Здесь то же самое. Сорри, немного бездумного кодинга. Вот заготовочка для копипасты времени:
                    ...
                    - 2010, 3, 28, 1, 15, 0
            */
            var timeLondon = new DateTimeOffset(2010, 3, 28, 3, 15, 0, TimeSpan.Zero);
            var timeMoscow = new DateTimeOffset(2010, 3, 28, 1, 15, 0, TimeSpan.FromHours(3));
            return (int)Math.Floor((timeLondon - timeMoscow).TotalMinutes + 1e-4);
        }
