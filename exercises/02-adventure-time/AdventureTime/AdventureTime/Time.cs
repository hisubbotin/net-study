    ...
    internal static class Time
    {
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            var moscowZonedTime = GetZonedTime(new DateTime(2010, 3, 28, 3, 15, 0), moscowZoneId.Id);
            var londonZonedTime = GetZonedTime(new DateTime(2010, 3, 28, 1, 15, 0), londonZoneId.Id);
