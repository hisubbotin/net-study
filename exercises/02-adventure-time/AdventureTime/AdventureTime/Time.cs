...
namespace AdventureTime
{
    ...
    internal static class Time
    {
        ...
        public static int GetAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                ...
                Держи, заготовочку для копипасты:
                    - 2010, 3, 28, 2, 15, 0
            */
            var time1 = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(0));
            var time2 = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(3));
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            ...
            */
            var time1 = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(0));
            var time2 = new DateTimeOffset(2010, 3, 28, 1, 15, 0, TimeSpan.FromHours(3));
            return (int)(time1 - time2).TotalMinutes;
           // throw new NotImplementedException();
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver1_FeelsSmarter()
        {
            ...
            */
            ...
            var time1 = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(1));
            var time2 = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(4));
            return (int)(time1 - time2).TotalMinutes;
            //throw new NotImplementedException();
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            var time1 = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), moscowZoneId);
            var time2 = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), londonZoneId);
            return (int)(time1 - time2).TotalMinutes;
