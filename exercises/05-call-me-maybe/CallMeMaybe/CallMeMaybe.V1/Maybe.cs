...
namespace CallMeMaybe.V1
{
    public struct Maybe<T>
    {
        /*
            ...
            Потому что структура -- значимый тип, а класс -- ссылочный. В значимых типах нет выделенного null, 
            а весь смысл Maybe в том, чтобы она не принимала значение null.
        */

        /// <summary>
        /// Зачем может быть нужно такое выделенное значение?
        /// Чтобы как-то обозначить, что в структуре нет значения
        ...
        /// Чтобы нельзя было инициализировать структуру как-то иначе, чем через монадный конструктор.
        /// </summary>
