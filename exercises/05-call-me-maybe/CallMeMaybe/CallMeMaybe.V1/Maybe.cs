...
namespace CallMeMaybe.V1
{
    ...
    {
        /*
            Q: Как ты думаешь, почему Maybe - структура?
            A: Чтобы его самого не приходилось проверять на null
        */

        /// <summary>
        /// Q: Зачем может быть нужно такое выделенное значение?
        /// A: Чтобы можно было сравнить с Maybe не содержащим значения
        /// Q: Сколько по факту будет экземпляров данного объекта?
        /// A: адын на класс
        /// </summary>
        ...
        /// <summary>
        /// Q: Как думаешь, почему я скрыл конструктор?
        /// A: Чтобы не создавать много пустых объектов
        /// </summary>
