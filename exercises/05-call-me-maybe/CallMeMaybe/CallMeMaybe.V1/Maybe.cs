...
namespace CallMeMaybe.V1
{
    public struct Maybe<T>
    {
        /*
            ...
            Возможно, потому что при "изменении" объекта типа Maybe должен создаваться новый объект.
        */

        /// <summary>
        /// Зачем может быть нужно такое выделенное значение?
        /// Чтобы был не null, а какой-то конкретный тип
        /// 
        ...
        /// 
        /// Наверное, потому что не должно быть возможности создать объект типа Maybe без явного вызова ToMaybe()
        /// </summary>
