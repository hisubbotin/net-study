...
namespace CallMeMaybe.V1
{
    public struct Maybe<T>
    {
        ...
        */
        ...
        /// 
        /// Чтобы обернуть null в что-то типизированное
        /// 
        /// Сколько по факту будет экземпляров данного объекта?
        /// 
        /// Хочется верить, что один
        /// </summary>
        ...
        /// 
        /// Возможно, потому что хочется пользоваться неявными преобразованиями и ToMaybe для конструирования
        /// </summary>
