...
namespace CallMeMaybe.V1
{
    public struct Maybe<T>
    {
        ...
        */
        ...
        /// <summary>
        /// Зачем может быть нужно такое выделенное значение? Для проверки пустоты
        /// Сколько по факту будет экземпляров данного объекта? Один
        /// </summary>
        ...
        /// Чтобы все использовали неявное приведение?
        /// </summary>
