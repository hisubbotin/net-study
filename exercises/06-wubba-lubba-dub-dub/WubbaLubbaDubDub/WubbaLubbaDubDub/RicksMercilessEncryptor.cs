    ...
    public static class RicksMercilessEncryptor
    {
        ...
        public static string CharsToCodes(this string s)
        {
            /*
                ...
                FYI: локальную функцию можно объявлять даже после строки с return. (Зачем это может быть нужно?)
        ...
        public static string InverseCase(this string s)
        {
            ...
            */
            ...
            return string.Join("", s.Select(InverseCase));
        }
        ...
        public static string ShiftInc(this string s)
        {
            ...
            {
                return char.ConvertFromUtf32(Convert.ToInt32(c) + 1);
            }

            return string.Join("", s.Select(ShiftChar));
        }
        ...
        public static IImmutableList<long> GetUsedObjects(this string text)
        {
            ...
            */
            ...
            return comment.Split(text).SelectMany(s => id.Matches(s).Select(m => m.Groups[0].Value))
