    ...
    */
    ...
    internal struct Vector
    {
        ...
        */
        ...
        /// </summary>
        /// <returns>Строковое<see cref="String"/> представление вектора<see cref="Vector"/>.</returns>
        ...
        */
        ...
        public static Vector operator -(Vector first, Vector second)
        {
            return first.Add(second.Scale(-1));
        }
        /// <summary>
        /// Оператор домножения вектора на скаляр.
        /// </summary>
        ...
        /// <summary>
        /// Оператор домножения скаляра на ветор.
        /// </summary>
