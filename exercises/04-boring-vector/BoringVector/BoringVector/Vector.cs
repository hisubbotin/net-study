...
namespace BoringVector
{
    ...
    */
    ...
    /// <summary>
    /// Двумерный вещественнозначный вектор, поддерживающий основные векторные операции.
    /// </summary>
    internal struct Vector
    {
        ...
        */
        ...
        /// <summary>
        /// Конструктор вектора. Параметрами передаются координаты.
        /// </summary>
        ...
        /// </summary>
        /// <returns>Длина вектора, <see cref="double"/></returns>
        public double SquareLength()
        {
            return X * X + Y * Y;
            // да, я неправильно прочитала задание :(
        }
        ...
        /// </summary>
        /// <param name="v">Вектор, с которым происходит сложение, <see cref="Vector"/></param>
        /// <returns> Вектор, предствляющий сумму двух векторов, <see cref="Vector"/></returns>
        ...
        /// </summary>
        /// <param name="k">Вещественное число, на которое происходит умножение, <see cref="double"/></param>
        /// <returns>Вектор, представляющий результат произведения вектора на число, <see cref="Vector"/></returns>
        ...
        /// <summary>
        /// Операция скалярного произведения двух векторов
        /// </summary>
        /// <param name="v">Вектор, на которое происходит скалярное умножение, <see cref="Vector"/></param>
        /// <returns>Вектор, представляющий результат скалярного произведения двух векторов, <see cref="double"/></returns>
        ...
        /// <summary>
        /// Операция векторного произведения двух векторов
        /// </summary>
        /// <param name="v">Вектор, на который происходит векторное умножение, <see cref="Vector"/></param>
        /// <returns>Вектор, представляющий результат векторного произведения двух векторов <see cref="double"/></returns>
        ...
        */
        ...
        /// </summary>
        /// <returns>Строка в формате (X; Y) из координат вектора, <see cref="string"/></returns>
    ...
    */
        ...
        {
            // это тот же самый вектор, потому что мы его просто домножили на +1
        ...
        /// <returns>Вектор, противоположный данному, <see cref="Vector"/></returns>
        public static Vector operator -(Vector v)
        {
            return new Vector(-v.X, -v.Y);
        }
        ...
        /// </summary>
        /// <param name="v1">Вектор слева от знака, <see cref="Vector"/></param>
        /// <param name="v2">Вектор справа от знака, <see cref="Vector"/></param>
        /// <returns>Вектор, представляющий сумму векторов, <see cref="Vector"/></returns>
        ...
        /// <param name="v1">Вектор слева от знака, <see cref="Vector"/></param>
        /// <param name="v2">Вектор справа от знака, <see cref="Vector"/></param>
        /// <returns>Вектор, представляющий разность векторов, <see cref="Vector"/></returns>
        public static Vector operator -(Vector v1, Vector v2)
        {
            return v2.Add(-v1);
        }
        ...
        /// </summary>
        /// <param name="k">Скаляр, <see cref="double"/></param>
        /// <param name="v">Вектор, на который необходимо домножить, <see cref="Vector"/></param>
        /// <returns>Вектор, представляющий результат умножения вектора на скаляр, <see cref="Vector"/></returns>
        ...
        /// </summary>
        /// <param name="v">Вектор, который необходимо разделить на число, <see cref="Vector"/></param>
        /// <param name="k">Скаляр, <see cref="double"/></param>
        /// <returns>Вектор, представляющий результат деления исходного вектора на скаляр, <see cref="Vector"/></returns>
    ...
    */
    ...
    /*
        ...
        Наведи теперь на NotImplementedException() - комментарий вC:\Users\irina\source\repos\net-study\exercises\04-boring-vector\BoringVector\BoringVector\Vector.csо всплывашке сделан с помощью такого же синтаксиса.
