...
namespace DrunkFibonacci
{
    internal class Program
    {
        private static void Main()
        {
            ...
            Console.WriteLine("FlattenChunkedSequence: " + string.Join(',', DrunkFibonacci.FlattenChunkedSequence().Take(10)));
            Console.WriteLine("GetGroupSizes: " + string.Join(',', DrunkFibonacci.GetGroupSizes().OrderBy(item => item.Key)));
        }
    }
}
