...
namespace Numbers
{
    public static class FloatNumbers
    {
        ...
        internal static int Compare(double first_num, double second_num/* дополни сигнатуру метода как считаешь правильным */)
        {
            /*
            ...
            */
            //throw new NotImplementedException();
            if(Math.Abs(first_num - second_num) < Double.Epsilon)
            {
                return 0;
            }
            else
