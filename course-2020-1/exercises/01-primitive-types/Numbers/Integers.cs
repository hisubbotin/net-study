...
namespace Numbers
{
    ...
    public static class Integers
    {
        ...
        internal static string ToHexString(int x)
        {
            ...
            */
            //throw new NotImplementedException();
            return x.ToString("x"); // еще можно сделать Convert.ToString(x, 16) и так имхо симпотичнее, но, насколько я нагуглил, Convert.ToString() может не быть в каких-то специфичных ситуациях
        }
