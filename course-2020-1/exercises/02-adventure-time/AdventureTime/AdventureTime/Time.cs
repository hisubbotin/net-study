...
namespace AdventureTime
{
    ...
    internal static class Time  
    {
        ...
        public static DateTime AddTenSecondsV2(DateTime dt)
        {
            ...
            */
            return dt.Add(TimeSpan.FromDays(10));
        }
        ...
        public static int GetTotalMinutesInThreeMonths()
        {
            ...
            System.Console.WriteLine("Avarage total minutes in three months is returned due to incorrect task.");
            return TimeSpan.FromDays((3 * (90 + 89 + 92 + 91 + 92 + 91 + 92 + 91 + 92 + 92 + 93 + 90)+ 
                                      91 + 90 + 92 + 91 + 92 + 91 + 92 + 91 + 92 + 92 + 93 + 91
                                     )/ 48.0).Minutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                ...
                Держи, заготовочку для копипасты:
                    - 2010, 3, 28, 2, 15, 0
            */
            DateTimeOffset london_time = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(0));
            DateTimeOffset moscow_time = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(3));
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                Здесь то же самое. Сорри, немного бездумного кодинга. Вот заготовочка для копипасты времени:
                    ...
                    - 2010, 3, 28, 1, 15, 0
            */
            DateTimeOffset london_time = new DateTimeOffset(2010, 3, 28, 1, 15, 0, TimeSpan.FromHours(0));
            DateTimeOffset moscow_time = new DateTimeOffset(2010, 3, 28, 3, 15, 0, TimeSpan.FromHours(3));
            return (int)((london_time - moscow_time).TotalMinutes);
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver1_FeelsSmarter()
        {
            ...
            */
            DateTimeOffset london_time = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(1));
            DateTimeOffset moscow_time = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(4));
            return (int)(london_time - moscow_time).TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            DateTimeOffset moscow_time = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), moscowZoneId);
            DateTimeOffset london_time = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), londonZoneId);
        ...
        {
            //I do not take into account the year of birth.
            if (person1Birthday.ToUniversalTime().Day   == person2Birthday.ToUniversalTime().Day &&
