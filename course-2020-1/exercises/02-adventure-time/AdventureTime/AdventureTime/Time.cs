...
namespace AdventureTime
{
    ...
    internal static class Time
    {
        ...
        {
            return DateTime.Parse(dtStr, null, DateTimeStyles.RoundtripKind); //TODO: second argument
            /*
        ...
        public static int GetHoursBetween(DateTime dt1, DateTime dt2)
        {
            ...
            /*
                ...
                Can't use TotalHours due to returning value's type (double)
        ...
        {
            return (int) TimeSpan.FromDays(92).TotalMinutes;
        ...
        {
            DateTimeOffset moscow_time = new DateTimeOffset(2010, 3, 28, 3, 15, 0,  TimeSpan.FromHours(4));
            DateTimeOffset london_time = new DateTimeOffset(2010, 3, 28, 1, 15, 0, TimeSpan.FromHours(1));
            return (int) (london_time - moscow_time).TotalMinutes;
            /*
        ...
        {
            DateTime p1birthday = ToUtc(person1Birthday);
            DateTime p2birthday = ToUtc(person2Birthday);
            return (p1birthday.Day == p2birthday.Day) && (p1birthday.Month == p2birthday.Month);
        }
    }
}
