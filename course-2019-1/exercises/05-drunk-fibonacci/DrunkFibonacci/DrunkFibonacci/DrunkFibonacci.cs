    ...
    internal static class DrunkFibonacci
    {
        ...
        public static IEnumerable<int> GetDrunkFibonacci()
        {
            ...
            */
            ...
            foreach (int rand in GetDeterministicRandomSequence())
            {
                count += 1;
        ...
        public static IEnumerable<int[]> GetInChunks()
        {
            ...
            int[] result = CreateIntArray(16);
            int count = 0;
            foreach (int fib in GetDrunkFibonacci())
            {
                result[count] = fib;
                count++;
                if (count == 16)
        ...
        public static Dictionary<int, int> GetGroupSizes()
        {
            ...
            */
            return GetDrunkFibonacci().Take(10000).GroupBy(
                    (x) => x % 8,
                    (k, v) => (k, v.Count())
