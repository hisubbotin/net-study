    ...
    internal static class DrunkFibonacci
    {
        ...
        public static IEnumerable<int> GetDrunkFibonacci()
        {
            ...
            */
            ...
            var randSeq = GetDeterministicRandomSequence().GetEnumerator();
        ...
        public static IEnumerable<int> GetXoredWithLaggedItself()
        {
            ...
            return GetDrunkFibonacci().Zip(GetDrunkFibonacci().Skip(42), (i, j) => i ^ j);
        }
        ...
        public static IEnumerable<int> FlattenChunkedSequence()
        {
            ...
            */
            return GetInChunks().SelectMany(x => x.OrderBy(e => e).Take(3));
        }
        ...
        public static Dictionary<int, int> GetGroupSizes()
        {
            ...
            */
            return GetDrunkFibonacci().Take(10000).GroupBy(x => (x % 8 + 8) % 8).ToDictionary(gr => gr.Key, gr => gr.Count());
        }
    }
}
