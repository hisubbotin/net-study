    ...
    internal static class DrunkFibonacci
    {
        ...
        public static IEnumerable<int> GetDrunkFibonacci()
        {
            ...
            */
            ...
            int current = 1;
            var index = 3;
            IEnumerable<int> gen = GetDeterministicRandomSequence().Skip(2);
            foreach (int fib in gen)
            {
                int next = unchecked(previous + current);
                previous = current;
                current = next;
        ...
        public static List<int> GetNextNegativeRange(int from = 1)
        {
            ...
            return GetDrunkFibonacci().Skip(from - 1).SkipWhile(x => x >= 0)
        ...
        public static IEnumerable<int> GetXoredWithLaggedItself()
        {
            ...
            IEnumerable<int> first = GetDrunkFibonacci();
            IEnumerable<int> second = GetDrunkFibonacci().Skip(42);
        ...
        public static IEnumerable<int[]> GetInChunks()
        {
            ...
            IEnumerable<int> gen = GetDrunkFibonacci();
            int[] chunk = CreateIntArray(16);
            int i = 0;
        ...
        public static IEnumerable<int> FlattenChunkedSequence()
        {
            ...
            */
            return GetInChunks().SelectMany(chunked => chunked.OrderBy(Math.Abs).Take(3));
        }
        ...
        public static Dictionary<int, int> GetGroupSizes()
        {
            ...
            */
            return GetDrunkFibonacci().Take(10000).GroupBy(value => Math.Abs(value) % 8)
