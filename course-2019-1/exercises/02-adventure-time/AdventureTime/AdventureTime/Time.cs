    ...
    internal static class Time
    {
        ...
        public static int GetAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            ...
            */
            ...
            DateTimeOffset t1 = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(3, 0, 0));
            DateTimeOffset t2 = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(0, 0, 0));
            return Convert.ToInt32((t2 - t1).TotalMinutes);
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                Здесь то же самое. Сорри, немного бездумного кодинга. Вот заготовочка для копипасты времени:
                    ...
                    - 2010, 3, 28, 1, 15, 0
            */
            DateTimeOffset t1 = new DateTimeOffset(2010, 3, 28, 3, 15, 0, new TimeSpan(3, 0, 0));
            DateTimeOffset t2 = new DateTimeOffset(2010, 3, 28, 1, 15, 0, new TimeSpan(0, 0, 0));
            return Convert.ToInt32((t2 - t1).TotalMinutes);
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver1_FeelsSmarter()
        {
            ...
            */
            DateTimeOffset t1 = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(4, 0, 0));
            DateTimeOffset t2 = new DateTimeOffset(2010, 3, 28, 2, 15, 0, new TimeSpan(1, 0, 0));
            return Convert.ToInt32((t2 - t1).TotalMinutes);
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            DateTimeOffset  t2 = GetZonedTime(to, londonZoneId);
            DateTimeOffset t1 = GetZonedTime(from, moscowZoneId);
            return Convert.ToInt32((t2 - t1).TotalMinutes);
        }
        ...
        {
            return person1Birthday.ToUniversalTime().Year == person2Birthday.ToUniversalTime().Year && 
                   person1Birthday.ToUniversalTime().DayOfYear == person2Birthday.ToUniversalTime().DayOfYear;
        }
    }
}
