...
namespace AdventureTime
{
    ...
    internal static class Time
    {
        ...
        public static int GetAdventureTimeDurationInMinutes_ver1_FeelsSmarter()
        {
            ...
            */
            DateTimeOffset London = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(1));
            DateTimeOffset Moscow = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(4));
            return (int)(London - Moscow).TotalMinutes;
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            return (int)(London - Moscow).TotalMinutes; //test need swap?
        }
