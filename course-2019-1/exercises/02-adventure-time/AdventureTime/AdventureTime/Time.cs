    ...
    internal static class Time
    {
        ...
        public static int GetAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            ...
            */
            ...
            DateTimeOffset arrive = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(0));
            DateTimeOffset depart = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(3));
            return (int)(arrive - depart).TotalMinutes;
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                Здесь то же самое. Сорри, немного бездумного кодинга. Вот заготовочка для копипасты времени:
                    ...
                    - 2010, 3, 28, 1, 15, 0
            */
            DateTimeOffset arrive = new DateTimeOffset(2010, 3, 28, 1, 15, 0, TimeSpan.FromHours(0));
            DateTimeOffset depart = new DateTimeOffset(2010, 3, 28, 3, 15, 0, TimeSpan.FromHours(3));
            return (int)(arrive - depart).TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver1_FeelsSmarter()
        {
            ...
            */
            DateTimeOffset arrive = new DateTimeOffset(2010, 3, 28, 1, 15, 0, TimeSpan.FromHours(1));
            DateTimeOffset depart = new DateTimeOffset(2010, 3, 28, 3, 15, 0, TimeSpan.FromHours(4));
            return (int)(arrive - depart).TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            DateTime localMsk = new DateTime(2010, 3, 28, 2, 15, 0);
            DateTime localLnd = new DateTime(2010, 3, 28, 2, 15, 0);

            DateTimeOffset zonedMsk = GetZonedTime(localMsk, moscowZoneId);
            DateTimeOffset zonedLnd = GetZonedTime(localLnd, londonZoneId);
            return (int)(zonedLnd - zonedMsk).TotalMinutes;
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            DateTime localMsk = new DateTime(2010, 3, 28, 3, 15, 0);
            DateTime localLnd = new DateTime(2010, 3, 28, 1, 15, 0);
