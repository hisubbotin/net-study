    ...
    internal static class Time
    {
        ...
        public static DateTime AddTenSecondsV2(DateTime dt)
        {
            /*
                ...
                А месяц сколько, 28, 29, 30, 31 день? Год высокостный или нет?
            */
        ...
        public static int GetHoursBetween(DateTime dt1, DateTime dt2)
        {
            ...
            */
            ...
            return Convert.ToInt32(Math.Floor((dt2 - dt1).TotalHours));
        }
        ...
        public static int GetTotalMinutesInThreeMonths()
        {
            ...
            // Месяц сколько?
            return Convert.ToInt32(Math.Floor(TimeSpan.FromDays(90).TotalMinutes));
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                ...
                Держи, заготовочку для копипасты:
                    - 2010, 3, 28, 2, 15, 0
            */
            var MSKTime = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(3));
            var GMTTime = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(0));
            return Convert.ToInt32(Math.Floor((GMTTime - MSKTime).TotalMinutes));
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver0_Dumb()
        {
            /*
                Здесь то же самое. Сорри, немного бездумного кодинга. Вот заготовочка для копипасты времени:
                    ...
                    - 2010, 3, 28, 1, 15, 0
            */
            var MSKTime = new DateTimeOffset(2010, 3, 28, 3, 15, 0, TimeSpan.FromHours(3));
            var GMTTime = new DateTimeOffset(2010, 3, 28, 1, 15, 0, TimeSpan.FromHours(0));
            return Convert.ToInt32(Math.Floor((GMTTime - MSKTime).TotalMinutes));
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver1_FeelsSmarter()
        {
            ...
            */
            var MSKTime = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(4));
            var GMTTime = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(1));
            return Convert.ToInt32(Math.Floor((GMTTime - MSKTime).TotalMinutes));
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            var MSKTime = new DateTime(2010, 3, 28, 2, 15, 0);
            var londonTime = new DateTime(2010, 3, 28, 2, 15, 0);
            return Convert.ToInt32(Math.Floor((GetZonedTime(londonTime, londonZoneId) - 
                GetZonedTime(MSKTime, moscowZoneId)).TotalMinutes));
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            var MSKTime = new DateTime(2010, 3, 28, 3, 15, 0);
