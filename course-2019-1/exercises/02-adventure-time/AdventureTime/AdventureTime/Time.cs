...
namespace AdventureTime
{
    ...
    public static class Time
    {
        ...
        /// </summary>
        public static DateTime WhatTimeIsIt() => DateTime.Now;

        /// <summary>
        /// Возвращает текущее время в UTC.
        /// </summary>
        public static DateTime WhatTimeIsItInUtc() => DateTime.UtcNow;
        ...
        public static DateTime SpecifyKind(DateTime dt, DateTimeKind kind) => DateTime.SpecifyKind(dt, kind);
        ...
        public static string ToRoundTripFormatString(DateTime dt) => dt.ToString("o");
        ...
        public static DateTime ParseFromRoundTripFormat(string dtStr) => DateTime.Parse(dtStr, null, DateTimeStyles.RoundtripKind);

        /// <summary>
        /// Преобразует значение текущего объекта <see cref="DateTime"/> во время UTC.
        /// </summary>
        public static DateTime ToUtc(DateTime dt) => dt.ToUniversalTime();
        ...
        public static DateTime AddTenSeconds(DateTime dt) => dt.AddSeconds(10);
        ...
        /// <param name="dt">Заданное время.</param>
        /// <returns>Время, передвинутое вперед на 10 секунд от заданного</returns>
        public static DateTime AddTenSecondsV2(DateTime dt) => dt + TimeSpan.FromSeconds(10);
        ...
        /// </summary>
        public static int GetTotalMinutesInThreeMonths() => (int) (DateTime.Now.AddMonths(3) - DateTime.Now).TotalMinutes;
        ...
        {
            DateTimeOffset timeLondon = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(0));
            DateTimeOffset timeMoscow = new DateTimeOffset(2010, 3, 28, 2, 15, 0, TimeSpan.FromHours(3));
            return (int) (timeLondon - timeMoscow).TotalMinutes;
        }
        ...
        {
            DateTimeOffset timeLondon = new DateTimeOffset(2010, 3, 28, 1, 15, 0, TimeSpan.FromHours(0));
            DateTimeOffset timeMoscow = new DateTimeOffset(2010, 3, 28, 3, 15, 0, TimeSpan.FromHours(3));
            return (int) (timeLondon - timeMoscow).TotalMinutes;
        }
        ...
        public static int GetAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            ...
            */
            ...
            DateTimeOffset timeLondon = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), londonZoneId);
            DateTimeOffset timeMoscow = GetZonedTime(new DateTime(2010, 3, 28, 2, 15, 0), moscowZoneId);
            return (int)(timeLondon - timeMoscow).TotalMinutes;
        }
        ...
        public static int GetGenderSwappedAdventureTimeDurationInMinutes_ver2_FeelsLikeRocketScience()
        {
            const string moscowZoneId = "Russian Standard Time";
            const string londonZoneId = "GMT Standard Time";
            DateTimeOffset timeLondon = GetZonedTime(new DateTime(2010, 3, 28, 1, 15, 0), londonZoneId);
            DateTimeOffset timeMoscow = GetZonedTime(new DateTime(2010, 3, 28, 3, 15, 0), moscowZoneId);
            return (int)(timeLondon - timeMoscow).TotalMinutes;
        }
