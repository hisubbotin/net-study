...
namespace Numbers
{
    public static class FloatNumbers
    {
        ...
        internal static int Compare(double first, double second, double epsilon = 1e-10)
        {
            /*
            ...
            */
            ...
            bool firstSmall = first < second;
            bool secondSmall = second < first;

            return (firstSmall == secondSmall || Math.Abs(first - second) < epsilon) ? 0 : 
                (firstSmall) ? -1 : 1 ;
        }
